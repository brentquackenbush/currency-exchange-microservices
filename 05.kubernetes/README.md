...
- Currency Exchange Service 
	- v11 - brentq/mmv2-currency-exchange-service:0.0.11-SNAPSHOT
  - v12 - brentq/mmv2-currency-exchange-service:0.0.12-SNAPSHOT
- Currency Conversion Service
	- brentq/mmv2-currency-conversion-service:0.0.11-SNAPSHOT
    - Uses CURRENCY_EXCHANGE_SERVICE_HOST
  - brentq/mmv2-currency-conversion-service:0.0.12-SNAPSHOT
...
docker push brentq/mmv2-currency-conversion-service:0.0.13-SNAPSHOT
docker push brentq/mmv2-currency-exchange-service:0.0.13-SNAPSHOT
```