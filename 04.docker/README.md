...
- Currency Exchange Service 
	- brentq/mmv2-currency-exchange-service:0.0.1-SNAPSHOT
- Currency Conversion Service
	- brentq/mmv2-currency-conversion-service:0.0.1-SNAPSHOT
- Eureka
	- brentq/mmv2-naming-server:0.0.1-SNAPSHOT
- API GATEWAY
	- brentq/mmv2-api-gateway:0.0.1-SNAPSHOT
